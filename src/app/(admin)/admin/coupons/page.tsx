        ...
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-border">
            {coupons.length === 0 ? (
              ...
              <tr key={coupon.id} className="min-[1025px]:hover:bg-secondary/50">
                ...
                <td className="px-4 py-3 text-right">
                  <Link href={`/admin/coupons/${coupon.id}`} className="p-1.5 rounded-md min-[1025px]:hover:bg-secondary inline-flex">
