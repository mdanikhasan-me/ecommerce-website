...
const FAQS = [
  ...
  },
  {
    ...
    items: [
      { q: 'Are all products on Boilabin authentic?', a: 'Yes. All products sold by the Boilabin Official Store are authentic. We source directly from authorized distributors and brand representatives.' },
