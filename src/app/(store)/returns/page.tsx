  ...
  return (
    <main className="bg-white text-foreground">
      ...
      <div className="container-site py-7 sm:py-9 lg:py-10">
        ...
        <section className="mt-3 grid gap-10 py-8 lg:grid-cols-2 lg:gap-16"><PolicyList title="What you can return" items={returnable} positive /><PolicyList title="What is not covered" items={excluded} positive={false} /></section>
