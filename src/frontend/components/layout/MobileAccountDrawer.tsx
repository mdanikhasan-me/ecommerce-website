  ...
  return (
    ...
    >
      ...
      <aside
        ...
        tabIndex={-1}
        className={cn(
          'absolute right-0 top-0 h-full w-[calc(100vw-4rem)] max-w-[20.5rem] transform-gpu overflow-hidden border-l border-black/10 bg-[#fffdfa] transition-transform duration-150 ease-out will-change-transform motion-reduce:transition-none',
