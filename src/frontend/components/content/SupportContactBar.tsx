...
export function SupportContactBar({
  ...
  return (
    <section aria-label="Support options" className="flex flex-col gap-4 rounded-lg bg-[#edf8f0] p-4 sm:gap-5 sm:p-6 lg:flex-row lg:items-center lg:justify-between">
