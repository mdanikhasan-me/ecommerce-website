  ...
  return (
    <div className="mx-auto max-w-lg text-center">
      <div className="mx-auto mb-4 w-fit rounded-2xl bg-primary/10 p-3">
        <LocalIcon name="package" className="h-8 w-8 text-primary" />
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex gap-2">
        <div className="relative flex-1">
          <LocalIcon name="search" className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" />
          <input
