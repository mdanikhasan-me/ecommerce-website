# Step 325 Next Prompt Draft

Continue after Step 324 in the Boilabin project.

Step 324 skipped the blocked media decision and aligned Advisor broad-staging warning detection with Terminal Loop behavior by treating `prohibit` / `prohibited` language as warning text.
...
If skipping media, choose one narrow non-media task, add focused tests if code changes, create a Step 325 report/evidence folder, validate, and stage exact files only.
...
1. Summary of the Step 325 decision/work
