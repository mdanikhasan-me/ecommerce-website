...
Continue after Step 312 in the Boilabin project.

This is Step 313: **subcategory managed media cleanup-readiness path fix**.
...
- touch payment, tracking, seller, env, packages, `/deals`, Flash Deals, or collections
...
- Create Step 313 evidence/report and next prompt draft.
...
```txt
audit-reports/313_SUBCATEGORY_MEDIA_CLEANUP_PATH_READINESS.md
...
Stage only Step 313 files:

- focused Step 313 source/test changes
- Step 313 audit report
- Step 313 next prompt draft
- Step 313 evidence files if created
