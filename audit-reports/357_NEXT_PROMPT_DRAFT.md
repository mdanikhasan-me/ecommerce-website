# Step 358 Next Prompt Draft

Continue after Step 357 in the Boilabin project.

Step 357 skipped the blocked media decision and hardened auth-host boundary handling for bracketed IPv6 localhost plus managed-host trust coverage.
...
If skipping media, choose one bounded non-media task, add focused tests if code changes, create a Step 358 report/evidence folder, validate, stage exact files only, commit, then push `origin main`.
...
1. Summary of the Step 358 decision/work
