# Step 326 Next Prompt Draft

Continue after Step 325 in the Boilabin project.

Step 325 skipped the blocked media decision and added the latest audit title to Terminal Loop state output for parity with Advisor state output.
...
If skipping media, choose one narrow non-media task, add focused tests if code changes, create a Step 326 report/evidence folder, validate, and stage exact files only.
...
1. Summary of the Step 326 decision/work
