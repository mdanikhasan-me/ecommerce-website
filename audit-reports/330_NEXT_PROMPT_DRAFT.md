# Step 331 Next Prompt Draft

Continue after Step 330 in the Boilabin project.

Step 330 skipped the blocked media decision and added synthetic Advisor and Terminal Loop tests proving same-step `NEXT_PROMPT_DRAFT` files sort before same-step completed audit reports.
...
If skipping media, choose one narrow non-media task, add focused tests if code changes, create a Step 331 report/evidence folder, validate, and stage exact files only.
...
1. Summary of the Step 331 decision/work
