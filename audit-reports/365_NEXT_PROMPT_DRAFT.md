# Step 366 Next Prompt Draft

Continue after Step 365 in the Boilabin project.

Step 365 skipped the blocked media decision and preserved private middleware route search parameters in safe internal login callback URLs.
...
If skipping media, choose one bounded non-media task, add focused tests if code changes, create a Step 366 report/evidence folder, validate, stage exact files only, commit, then push `origin main`.
...
1. Summary of the Step 366 decision/work
