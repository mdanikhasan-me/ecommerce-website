# Step 332 Next Prompt Draft

Continue after Step 331 in the Boilabin project.

Step 331 skipped the blocked media decision and added synthetic Advisor and Terminal Loop tests proving malformed audit-report files and directories are ignored by helper report scanners.
...
If skipping media, choose one narrow non-media task, add focused tests if code changes, create a Step 332 report/evidence folder, validate, and stage exact files only.
...
1. Summary of the Step 332 decision/work
