# Step 330 Next Prompt Draft

Continue after Step 329 in the Boilabin project.

Step 329 skipped the blocked media decision and added Advisor and Terminal Loop test coverage proving helper state does not treat `NEXT_PROMPT_DRAFT` files as the latest completed audit report.
...
If skipping media, choose one narrow non-media task, add focused tests if code changes, create a Step 330 report/evidence folder, validate, and stage exact files only.
...
1. Summary of the Step 330 decision/work
