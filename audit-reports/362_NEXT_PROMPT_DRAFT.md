# Step 363 Next Prompt Draft

Continue after Step 362 in the Boilabin project.

Step 362 skipped the blocked media decision and hardened middleware matcher exclusions so framework/static lookalike paths are not skipped by middleware.
...
If skipping media, choose one bounded non-media task, add focused tests if code changes, create a Step 363 report/evidence folder, validate, stage exact files only, commit, then push `origin main`.
...
1. Summary of the Step 363 decision/work
