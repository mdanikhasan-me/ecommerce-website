...
export const CANONICAL_PRODUCT_IMAGE_REPLACEMENTS = [
  {
    ...
    local: '/assets/products/catalog/iphone-15-pro-128gb.jpg',
  ...
  },
  {
    ...
    local: '/assets/products/catalog/samsung-galaxy-s24-ultra-256gb.jpg',
  ...
  },
  {
    ...
    local: '/assets/products/catalog/anker-737-power-bank-24000mah.webp',
    note: 'Exact committed product upload.',
  },
  {
    ...
    local: '/assets/products/catalog/anker-511-nano-pro-65w-charger.jpg',
    note: 'Exact committed product upload.',
  },
  {
    ...
    local: '/assets/products/catalog/dell-ultrasharp-27-4k-usb-c-u2723de.jpg',
    note: 'Exact committed product upload.',
  },
  {
    ...
    local: '/assets/products/catalog/samsung-galaxy-tab-s9-128gb.jpg',
  ...
  },
  {
    ...
    local: '/assets/products/catalog/xiaomi-redmi-note-13-pro-256gb.webp',
    note: 'Exact committed product upload.',
  },
]
